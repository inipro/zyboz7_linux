...
if { $list_projs eq "" } {
   create_project pcam5c pcam5c -part xc7z020clg400-1
...
\
  ...
  connect_bd_net -net clk_wiz_0_clk_133M [get_bd_pins clk_wiz_0/clk_133M] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins v_proc_ss_0/aclk] [get_bd_pins v_frmbuf_wr_0/ap_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins rst_clk_wiz_0_133M/slowest_sync_clk] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
  ...
  connect_bd_net -net rst_clk_wiz_0_133M_peripheral_aresetn [get_bd_pins rst_clk_wiz_0_133M/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins smartconnect_0/aresetn]
